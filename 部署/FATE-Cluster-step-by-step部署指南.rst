...
|   | d |     |    |           |         |                            |
+===+===+=====+====+===========+=========+============================+
| P | 1 | V   | 1  | CentOS    | fate，  | fat                        |
| a | 0 | M_0 | 92 | 7         | eggroll | e_flow，fateboard，cluster |
| r | 0 | _1_ | .1 | .2/Ubuntu | ，mysql | manager，nodemanger，mysql |
| t | 0 | cen | 68 | 16.04     |         |                            |
| y | 0 | tos | .0 |           |         |                            |
| A |   |     | .1 |           |         |                            |
+---+---+-----+----+-----------+---------+----------------------------+
| P | 1 | V   | 1  | CentOS    | fate,   | nodemanger，rollsite       |
...
| A |   |     | .2 |           |         |                            |
+---+---+-----+----+-----------+---------+----------------------------+
| P | 9 | V   | 1  | CentOS    | fate，  | all                        |
| a | 9 | M_0 | 92 | 7         | eggroll |                            |
| r | 9 | _3_ | .1 | .2/Ubuntu | ，mysql |                            |
| t | 9 | cen | 68 | 16.04     |         |                            |
| y |   | tos | .0 |           |         |                            |
| B |   |     | .3 |           |         |                            |
+---+---+-----+----+-----------+---------+----------------------------+
